...
class UsersPlugin(base.BaseCloudConfigPlugin):
    ...
    def _create_user(self, item, osutils):
            ...
            no_create_home = item.get('no_create_home ', False)
            if user_disabled and (public_keys or not no_create_home):
            ...
            if (not user_disabled and (public_keys or not no_create_home)):
